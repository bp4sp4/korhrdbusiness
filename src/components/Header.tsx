      ...
      >
        ...
        >
          ...
          <nav className="w-full flex flex-col items-center gap-2 mb-6 px-4">
            <Link
              href="/about"
              className="w-full py-3 text-lg font-semibold text-white hover:bg-[#22304a] rounded transition"
              onClick={() => setMenuOpen(false)}
            >
              회사 소개
            </Link>
            ...
            <button
              onClick={handleOpenCounselModal}
              className="w-full py-3 text-lg font-semibold text-white hover:bg-[#22304a] rounded transition bg-transparent border-none text-left md:text-left"
            >
              교육상담받기
            </button>
            <Link
