...
export default function Test() {
  ...
  const SectionCards = ({
    ...
    if (swipeOnMobile && isMobile) {
      return (
        <div className="mb-12">
          <Swiper spaceBetween={16} slidesPerView={1} className="w-full px-2">
            {cards.map((card, idx) => (
              <SwiperSlide key={card.img + idx}>
                <div className="flex justify-center">
                  <Card className="relative h-[314px] w-[274px] flex flex-col justify-end overflow-hidden rounded-2xl shadow-lg">
                    <img
                      src={card.img}
                      alt=""
    ...
    return (
      <div className="mb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 service__card text-left px-2 md:px-6">
          {cards.map((card, idx) => (
            <Card
