...
export const metadata: Metadata = {
  ...
  description:
    "에듀바이저스(한평생 에듀바이저스)는 1:1 맞춤형 커리어 설계와 실무 중심 교육을 통해 당신의 성공적인 취업과 커리어 개발을 돕습니다. 자격증, 유학 프로그램까지 한평생교육의 전문가가 함께합니다.",
  keywords: [
    "에듀바이저스",
    "한평생 에듀바이저스",
    "한평생에듀바이저스",
  ...
  twitter: {
    ...
    title: "에듀바이저스 | 한평생 에듀바이저스 - 당신의 커리어 성장 파트너",
    description:
      "에듀바이저스(한평생 에듀바이저스)에서 제공하는 1:1 맞춤형 커리어 설계와 실무 교육을 통해 취업에 성공하세요. 자격증, 유학 프로그램까지 한평생교육의 전문가가 함께합니다.",
